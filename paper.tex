...
\begin{equation}
\begin{split}
\forall y \Big( &\text{Susceptible}(y, t) \land (\exists x \ \text{Infected}(x, t) \land \text{Neighbor}(x, y)) \\
&\rightarrow P(\text{Infected}(y, t+1)) = 1 - (1 - \beta)^{k_I} \Big)
\end{split}
\end{equation}
...
\begin{enumerate}[leftmargin=*, label={[\arabic*]}]
    \item Erdős, P., \& Rényi, A. (1960). On the evolution of random graphs. \textit{Publications of the Mathematical Institute of the Hungarian Academy of Sciences}, 5(1), 17--60.
    ...
    \item Kermack, W. O., \& McKendrick, A. G. (1927). A contribution to the mathematical theory of epidemics. \textit{Proceedings of the Royal Society A}, 115(772), 700--721.
    
    \item Newman, M. E. J. (2002). Spread of epidemic disease on networks. \textit{Physical Review E}, 66(1), 016128.
    
    \item Pastor-Satorras, R., \& Vespignani, A. (2001). Epidemic spreading in scale-free networks. \textit{Physical Review Letters}, 86(14), 3200--3203.
    
    \item Gross, T., D'Lima, C. J. D., \& Blasius, B. (2006). Epidemic dynamics on an adaptive network. \textit{Physical Review Letters}, 96(20), 208701.
    
    \item Shaw, L. B., \& Schwartz, I. B. (2008). Fluctuating epidemics on adaptive networks. \textit{Physical Review E}, 77(6), 066101.
    
    \item Keeling, M. J., \& Eames, K. T. (2005). Networks and epidemic models. \textit{Journal of the Royal Society Interface}, 2(4), 295--307.
    
    \item Holme, P., \& Saramäki, J. (2012). Temporal networks. \textit{Physics Reports}, 519(3), 97--125.
    
    \item Funk, S., Gilad, E., Watkins, C., \& Jansen, V. A. (2009). The spread of awareness and its impact on epidemic outbreaks. \textit{Proceedings of the National Academy of Sciences}, 106(16), 6872--6877.
    
    \item Block, P., Hoffman, M., Raabe, I. J., Dowd, J. B., Rahal, C., Kashyap, R., \& Mills, M. C. (2020). Social network-based distancing strategies to flatten the COVID-19 curve in a post-lockdown world. \textit{Nature Human Behaviour}, 4(6), 588--596.
\end{enumerate}
